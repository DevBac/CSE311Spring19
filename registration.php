  	...
  	<div class="container">
    	...
    	<div class="right">
      		<div class="registration">
                ...
                <p>Occupation</p>
          			<input type="text" name="registration_user_occupation" placeholder="Enter occupation">
          			<p>Password *</p>
          			...
          			<h5><i><a href="https://salekur.blogspot.com/p/privacy-policy.html" target="_blank">Terms & conditions*</a></i></h5>
            ...
            <?php
              if (isset($_POST['registration_user_name'])) {
                ...
                if(mysqli_num_rows($account) > 0) {
                  ...
                  $sql = "INSERT INTO users (name, email, bdate, occupation, password)
                  VALUES('$name', '$email', '$bdate', '$occupation', '$password')";
